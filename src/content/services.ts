...
const ru: Service[] = [
  {
    slug: "energy-therapy",
    order: 1,
    name: "Энергетическая терапия",
    tagline: "Восстановить нервную систему. Вернуться к себе.",
    summary:
      "Сердце практики. Бережный, глубоко восстанавливающий метод, чтобы успокоить перегруженную нервную систему, отпустить последствия хронического стресса и вернуться в баланс с собой.",
    promise: "Мягко ваша система вспоминает, каково это — быть в безопасности.",
    format: "Онлайн и лично · 1:1",
    accent: "gold",
    hero: {
      variant: "dawn",
      motif: "sun",
    ...
    forWhom: {
      ...
      items: [
        "Вы несёте груз хронического стресса и не можете до конца выдохнуть.",
        "Вы потеряли связь с собой — живёте на автопилоте.",
        "Сон, энергия или эмоции незаметно вышли из равновесия.",
        "Внешне вы восстановились, но внутри всё ещё напряжены.",
        "Вы хотите настоящего покоя, а не его видимости.",
      ],
    },
    benefits: [
      {
        title: "Спокойная нервная система",
        body: "Мы бережно выводим вас из режима выживания обратно к отдыху, чтобы тело наконец расслабилось и восстановилось.",
      },
      {
        title: "Эмоциональный баланс",
        body: "Старое напряжение и удержанные эмоции встречаются и отпускаются, оставляя больше пространства, устойчивости и воздуха.",
      },
      {
        title: "Саморегуляция, которая остаётся",
        body: "Вы уходите с ощущением собственного центра — и простыми практиками, чтобы возвращаться к нему самостоятельно.",
      },
      {
        title: "Возвращение связи",
        body: "За шумом вы снова встречаете себя: свои потребности, интуицию, естественное состояние.",
      },
    ],
    process: [
      {
        index: "01",
        title: "Приход",
        body: "Мы начинаем с тихого разговора. Без давления и ролей — просто приземлиться и услышать, где вы сейчас.",
      },
      {
        index: "02",
        title: "Настройка",
        body: "Я считываю состояние вашей системы, и мы задаём мягкое намерение. Вам остаётся только принимать.",
      },
      {
        index: "03",
        title: "Отпускание",
        body: "Через работу с энергией, дыхание и глубокое расслабление удержанный стресс начинает двигаться, а система смягчается в безопасность.",
      },
      {
        index: "04",
        title: "Интеграция",
        body: "Мы завершаем заземлением и несколькими практиками под вас, чтобы покой продолжал жить в ваших днях.",
      },
    ],
    results: [
      "Более глубокий, спокойный сон",
      "Спокойный, ясный ум",
      "Устойчивые эмоции",
      "Больше энергии в течение дня",
      "Ощущение безопасности в теле",
      "Возвращённая связь с интуицией",
    ],
    faqs: [
      {
        q: "Что на самом деле происходит на сессии?",
        a: "Вы отдыхаете, в одежде и удобстве, а я работаю с энергетическим полем и нервной системой через мягкое внимание, дыхание и — на личной встрече — лёгкие прикосновения. Большинство описывают это как глубокое расслабление, как выдох после многих лет задержанного дыхания.",
      },
      {
        q: "Работает ли это онлайн?",
        a: "Да. Энергия не ограничена расстоянием. Онлайн-сессии проходят по видео в тишине вашего пространства и не менее глубоки, чем встреча в одной комнате — многие предпочитают именно их.",
      },
      {
        q: "Сколько сессий мне понадобится?",
        a: "Кто-то чувствует сдвиг уже после одной. Для устойчивых изменений при хроническом стрессе ритм сессий в течение нескольких недель позволяет нервной системе постепенно заново научиться безопасности. Мы решаем вместе, без давления.",
      },
      {
        q: "Это психотерапия или лечение?",
        a: "Это дополняющая, восстановительная практика для благополучия и саморегуляции. Она прекрасно сочетается с медицинской или психологической помощью и никогда её не заменяет.",
      },
      {
        q: "Я чувствительная / скептик / очень уставшая. Это нормально?",
        a: "Всё это уместно. Чувствительность здесь — преимущество, скептицизм безопасен, а усталость — именно то, с чем работает эта практика. Вам не нужно ни во что верить, чтобы тело смягчилось.",
      },
    ],
    cta: {
      title: "Начните с сессии",
      body: "Первый шаг — мягкий разговор. Расскажите, где вы сейчас, и мы найдём подходящий путь.",
